...
class cslCitation1 extends LitElement {
  ...
  if (event.keyCode === 13) {
    ...
    var new_event = new CustomEvent('new-citation1',
...
if (!customElements.get('csl-citation1')) {
customElements.define('csl-citation1', cslCitation1);}
